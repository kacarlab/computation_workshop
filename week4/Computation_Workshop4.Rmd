...
options(
  ...
  repr.plot.res    = 150   # bump resolution (DPI); 150–200 is usually good
)
```
...
```{r}
ggsave("/Users/fer/Desktop/week4/phylogenetic_tree_with_kingdom_and_heatmap.png", plot = p_heat, width = 10, height = 8, dpi = 300)
```
